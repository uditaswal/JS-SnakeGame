...
// Function to start playing game audio
...
function startGame() {
  ...
  // let timerDisplay;
  updateTimer();
  // timerDisplay = document.getElementById("timer").innerText;
...
function generateRedBall() {
  ...
  // to genrerate ball in ranfdom locations
  ballLocationX =
...
function move() {
  ...
  currentTop = parseInt(currentHead.style.top);
  currentLeft = parseInt(currentHead.style.left);
